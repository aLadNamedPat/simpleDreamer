...
"""
Memory-efficient CMA-ES training for systems with limited RAM.
Uses sequential candidate evaluation with small vectorized environments.
"""
...
def train_controller_cma(
    ...
    """
    Train controller using CMA-ES with memory-efficient evaluation.
    """
    vae.eval()
    rnn.eval()
...
def main():
    parser = argparse.ArgumentParser(description="Train controller with CMA-ES (Memory Efficient)")
    ...
    print("=" * 60)
    print("CMA-ES Controller Training (Memory Efficient)")
    print("=" * 60)
